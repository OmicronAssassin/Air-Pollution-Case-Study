...
The overall goal of this Exploratory Data Analysis coursera Project is to explore the National Emissions Inventory database and see what it say about fine particulate matter pollution in the United states over the 10-year period 1999–2008. You may use any R package you want to support your analysis.
...
Each question was answered by constructing R script and generating PNG image. The scripts contain the code for reading the data and the code that generates the PNG file.